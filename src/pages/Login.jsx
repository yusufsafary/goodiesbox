...
export default function Login() {
  ...
  return (
    <>
      <SEO
        title="Sign In – PromptPlay"
        description="Sign in to PromptPlay to save your archetype receipts, track your prompting style over time, and appear on the leaderboard."
        canonical="/login"
        noindex={true}
      />
