...
export default function Beta() {
  ...
  return (
    <>
      <SEO
        title="Beta Testnet – Analyze Your AI Prompts & Get Your Archetype"
        description="Paste your AI prompts and get your personalized prompting archetype receipt instantly. Free, in-browser, no account needed. Find out if you're a Vibe Coder, Overthinker, or Debugger."
        canonical="/beta"
      />
            ...
            <div className="animate-in animate-in-delay-2">
              ...
              <div className="card-dark rounded-2xl overflow-hidden mb-4">
                ...
                <textarea
                  ...
                  rows={10}
                  disabled={loading}
                  aria-label="Paste your AI prompts here"
                />
              ...
              {/* Error */}
              {error && (
                <div className="flex items-start gap-2 p-3 rounded-xl bg-red-500/10 border border-red-500/20 mb-4" role="alert">
              ...
              {/* Loading state */}
              {loading && (
                <div className="mt-6 card-dark rounded-2xl p-5 font-mono text-xs text-pp-muted space-y-2" aria-live="polite">
