...
export default function About() {
  return (
    <>
      <SEO
        title="About PromptPlay – AI Prompt Archetype Analyzer"
        description="Learn how PromptPlay analyzes your AI prompting habits. Discover the 8 prompter archetypes, how the in-browser analysis works, and the story behind the tool."
        canonical="/about"
        jsonLd={faqJsonLd}
      />
      <div className="min-h-screen pt-20 pb-16 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-10 animate-in animate-in-delay-3">
            <h2 className="font-bold text-pp-text mb-5 text-lg">FAQ</h2>
            <dl className="space-y-3">
              {FAQ.map(({ q, a }) => (
                <div key={q} className="card-dark rounded-xl p-4 border border-pp-border">
                  <dt className="font-semibold text-pp-text text-sm mb-1">{q}</dt>
          ...
          {/* CTA */}
          <div className="text-center animate-in animate-in-delay-4">
            <Link to="/beta" className="btn-primary inline-flex text-sm">
